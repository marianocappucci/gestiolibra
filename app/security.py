"""Password hashing for Gestiolibra's own users table.
...
while Gestiolibra is PostgreSQL/SQLAlchemy. This is the same algorithm
applied to Gestiolibra's own storage, not a different security posture.
"""
import hashlib
import hmac
import secrets
