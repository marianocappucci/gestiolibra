...
usuario veía el texto del motor: reportado el 2026-08-06 en MedLibra, que comparte este motor,
...
POR_NOMBRE = {
    ...
    "ServiceNotFound": (404, "No se encontró el servicio."),
    "AppointmentConflict": (
        409,
        "Ese horario ya está ocupado. Elegí otro o revisá la agenda del recurso.",
    ),
    "AppointmentUnavailable": (
        409,
        "El recurso no está disponible en ese horario. Revisá su disponibilidad en Recursos.",
    ),
    "OutsideBusinessHours": (
        409,
        "El horario elegido está fuera del horario de atención. Revisá los "
        "horarios de la sucursal y del recurso.",
    ),
    "OverbookingLimitReached": (
        409,
        "Se llegó al tope de sobreturnos del día para ese recurso.",
    ),
    "ResourceBranchMismatch": (
        409,
        "El recurso no pertenece a esa sucursal.",
    ),
}
