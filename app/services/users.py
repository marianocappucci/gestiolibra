...
Contalibra/Restolibra/MedLibra/VentaLibra, ver wiki/entities/gestiolibra.md
sección "Unificación de login").

Gestiolibra ya tenía una segunda base SQLite configurada para libracore.db
...
def ensure_default_admin(repo: UserRepository) -> None:
    ...
    libracore.db.usuarios: sin GESTIOLIBRA_ADMIN_PASSWORD la app no arranca
