...
by design (the engine "no calcula porcentajes ni conoce precios de
servicio" -- same principle already established for señas/Deposit). One
service can cost differently at different branches, so this is a
service x branch -> price table, not a single price on Service.
"""
