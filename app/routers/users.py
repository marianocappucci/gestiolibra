"""Router de usuarios de Gestiolibra: shim sobre la factory única de la
familia (`libraauth.usuarios.build_users_router()`, ADR-018, libraauth
v0.43.0). Reemplaza la copia propia que tenía este archivo -- byte-idéntica
a la de MedLibra, ver el historial de `services/users.py` -- con dos
defectos que la factory cierra:
