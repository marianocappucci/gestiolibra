...
class UserCreate(BaseModel):
    ...
    # ninguna otra tabla de Gestiolibra lo referencia como FK, así que no
    # hay ningún callsite que dependiera de elegir el id (ver
    # wiki/entities/gestiolibra.md "Unificación de login").
    username: str
    name: str
    password: str
    role: Role
