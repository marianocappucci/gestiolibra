"""Configuracion ARCA del negocio (admin-only).

Gestiolibra es de instancia unica por cliente -- una sola "empresa" ARCA,
sin lista de empresas para elegir (a diferencia de Contalibra/Restolibra,
