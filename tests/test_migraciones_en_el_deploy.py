...
#: LibraCore de este producto vive en `gestiolibra_core`, una base aparte, y su
...
def test_libraauth_migra_la_base_de_LIBRACORE_y_no_la_del_dominio():
    ...
    (`gestiolibra_core`): medido el 2026-09-16 en la demo y en dev, **6/6 ahi y 0/6
    ...
    assert comando[comando.index("--base") + 1] == "core", (
        f"las tablas de auth de gestiolibra viven en la base de LibraCore: --base core, "
