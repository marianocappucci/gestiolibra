...
def _seeded_client(client: TestClient):
    # 🔴 **La sucursal va en UTC a proposito**, aunque el default del alta
    # sea Argentina. Este archivo mide plazos de recordatorio contra `now()`, y
    ...
    client.post("/branches", json={
        "id": "branch-1", "name": "Centro", "timezone": "UTC",
    })
