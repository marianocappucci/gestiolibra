...
# tambien en dev local en WSL sin identidad SSH propia. Mismo mecanismo de
# reescritura a git+ssh en el build del VPS -- pero este stage node:20-slim
...
# `agent-multi-libra.sock` que ya carga las de libracore/libragenda).
